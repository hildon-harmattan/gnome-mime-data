...
pkgdatadir = $(datadir)/gnome-mime-data
pkglibdir = $(libdir)/gnome-mime-data
pkgincludedir = $(includedir)/gnome-mime-data
...
DIST_COMMON = README $(am__configure_deps) $(srcdir)/Makefile.am \
	...
	$(srcdir)/gnome-mime-data-2.0.pc.in \
	$(srcdir)/gnome-mime-data-zip.in \
	$(srcdir)/gnome-mime-data.spec.in $(top_srcdir)/configure \
...
CONFIG_CLEAN_FILES = gnome-mime-data.spec gnome-mime-data-zip \
...
DATA = $(applications_DATA) $(mime_DATA) $(pkgconfig_DATA) \
	$(sysconf_DATA)
...
ACLOCAL = ${SHELL} /home/qwazix/cordia/gnome-mime-data-2.18.0/missing --run aclocal-1.10
...
AMTAR = ${SHELL} /home/qwazix/cordia/gnome-mime-data-2.18.0/missing --run tar
AUTOCONF = ${SHELL} /home/qwazix/cordia/gnome-mime-data-2.18.0/missing --run autoconf
AUTOHEADER = ${SHELL} /home/qwazix/cordia/gnome-mime-data-2.18.0/missing --run autoheader
AUTOMAKE = ${SHELL} /home/qwazix/cordia/gnome-mime-data-2.18.0/missing --run automake-1.10
AWK = gawk
CATALOGS =  af.gmo am.gmo ar.gmo az.gmo be.gmo bg.gmo bn.gmo bs.gmo ca.gmo cs.gmo cy.gmo da.gmo de.gmo el.gmo en_CA.gmo en_GB.gmo eo.gmo es.gmo et.gmo eu.gmo fa.gmo fi.gmo fr.gmo ga.gmo gl.gmo gu.gmo he.gmo hi.gmo hr.gmo hu.gmo id.gmo is.gmo it.gmo ja.gmo ko.gmo li.gmo lt.gmo lv.gmo mk.gmo ml.gmo mn.gmo ms.gmo nb.gmo ne.gmo nl.gmo nn.gmo nso.gmo pa.gmo pl.gmo pt.gmo pt_BR.gmo ro.gmo ru.gmo rw.gmo sk.gmo sl.gmo sq.gmo sr.gmo sr@ije.gmo sr@Latn.gmo sv.gmo ta.gmo th.gmo tk.gmo tr.gmo uk.gmo vi.gmo wa.gmo xh.gmo yi.gmo zh_CN.gmo zh_TW.gmo zu.gmo
CATOBJEXT = .gmo
CC = gcc
...
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /home/qwazix/cordia/gnome-mime-data-2.18.0/missing --run makeinfo
MKDIR_P = /scratchbox/tools/bin/mkdir -p
MKINSTALLDIRS = ./mkinstalldirs
MSGFMT = /usr/bin/msgfmt
OBJEXT = o
PACKAGE = gnome-mime-data
PACKAGE_BUGREPORT = http://bugzilla.gnome.org/enter_bug.cgi?product=gnome-mime-data
PACKAGE_NAME = gnome-mime-data
PACKAGE_STRING = gnome-mime-data 2.18.0
PACKAGE_TARNAME = gnome-mime-data
PACKAGE_VERSION = 2.18.0
PATH_SEPARATOR = :
POFILES =  af.po am.po ar.po az.po be.po bg.po bn.po bs.po ca.po cs.po cy.po da.po de.po el.po en_CA.po en_GB.po eo.po es.po et.po eu.po fa.po fi.po fr.po ga.po gl.po gu.po he.po hi.po hr.po hu.po id.po is.po it.po ja.po ko.po li.po lt.po lv.po mk.po ml.po mn.po ms.po nb.po ne.po nl.po nn.po nso.po pa.po pl.po pt.po pt_BR.po ro.po ru.po rw.po sk.po sl.po sq.po sr.po sr@ije.po sr@Latn.po sv.po ta.po th.po tk.po tr.po uk.po vi.po wa.po xh.po yi.po zh_CN.po zh_TW.po zu.po
POSUB = po
PO_IN_DATADIR_FALSE = 
PO_IN_DATADIR_TRUE = 
SET_MAKE = 
...
abs_builddir = /home/qwazix/cordia/gnome-mime-data-2.18.0
abs_srcdir = /home/qwazix/cordia/gnome-mime-data-2.18.0
abs_top_builddir = /home/qwazix/cordia/gnome-mime-data-2.18.0
abs_top_srcdir = /home/qwazix/cordia/gnome-mime-data-2.18.0
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = $(SHELL) /home/qwazix/cordia/gnome-mime-data-2.18.0/install-sh
...
gnome-mime-data.spec: $(top_builddir)/config.status $(srcdir)/gnome-mime-data.spec.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
gnome-mime-data-zip: $(top_builddir)/config.status $(srcdir)/gnome-mime-data-zip.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
gnome-mime-data-2.0.pc: $(top_builddir)/config.status $(srcdir)/gnome-mime-data-2.0.pc.in
	cd $(top_builddir) && $(SHELL) ./config.status $@
...
installdirs-am:
	for dir in "$(DESTDIR)$(applicationsdir)" "$(DESTDIR)$(mimedir)" "$(DESTDIR)$(pkgconfigdir)" "$(DESTDIR)$(sysconfdir)"; do \
...
install-data-am: install-applicationsDATA install-mimeDATA \
...
uninstall-am: uninstall-applicationsDATA uninstall-mimeDATA \
...
.PHONY: $(RECURSIVE_CLEAN_TARGETS) $(RECURSIVE_TARGETS) CTAGS GTAGS \
	...
	uninstall-applicationsDATA uninstall-mimeDATA \
	uninstall-pkgconfigDATA uninstall-sysconfDATA
